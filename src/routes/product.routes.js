...
const { CreateProduct, GetAllProducts, UpdateProduct, GetProduct, DeleteProduct, productFilteredByCategory, productFilteredByPrice, UpdateImg } = require('../controllers/product.controller.js');
